...
export function SellerArtworkForm({ id, initial, onSaved }: SellerArtworkFormProps) {
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    const response = await fetch(`/api/seller/artworks/${id}`, {
      method: "PATCH",
