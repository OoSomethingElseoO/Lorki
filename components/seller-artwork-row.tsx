...
import { SellerArtworkForm } from "@/components/seller-artwork-form";
import { DeleteButton } from "@/components/admin/delete-button";
import { Button } from "@/components/ui/button";

type SellerArtworkRowProps = {
  artwork: {
    id: string;
    title: string;
    kind: "ORIGINAL" | "PRINT";
...
export function SellerArtworkRow({ artwork, causeName }: SellerArtworkRowProps) {
  const [isEditing, setIsEditing] = useState(false);
  // Once sold, the piece is immutable — /api/seller/artworks/[id] already
