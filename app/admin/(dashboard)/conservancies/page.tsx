...
export default async function AdminConservanciesPage({ searchParams }: PageProps) {
  ...
  return (
    <>
      <h1>Conservancies</h1>
      <Tabs defaultValue="conservancies">
        <TabsList aria-label="Conservancy sections">
          <TabsTrigger value="conservancies">Conservancies</TabsTrigger>
          <TabsTrigger value="add">Add conservancy</TabsTrigger>
        </TabsList>

        <TabsContent value="conservancies">
                ...
                <tr>
                  <td colSpan={7}>
                    <EmptyState
                      ...
                      hint={query ? "Try a different search term." : "Use the Add conservancy tab to add your first conservancy."}
                    />
                  </td>
                </tr>
              ) : null}
