...
export default async function ArtistDashboardPage() {
  ...
  // here. Full management (edit/delete) stays on /artist/artworks; this is
  ...
  return (
    <>
      ...
      <p className="admin-form__hint">
        Selling as <strong>{artist.name}</strong> ({artist.country})
      </p>
      ...
      <Tabs defaultValue="campaigns">
        <TabsList aria-label="Artist dashboard sections">
        ...
        <TabsContent value="campaigns">
          <Card variant="brand">
            <CardHeader>
              ...
              <Link href="/artist/campaigns/new" className={buttonVariants()}>
                ...
                campaigns.map((campaign) => (
                  <article className="campaign-card" key={campaign.id} style={{ marginBottom: "1rem" }}>
                    ...
                    {campaign.status === "LIVE" || campaign.status === "DRAFT" ? (
                      <Link href={`/artist/artworks/new?campaignId=${campaign.id}`} className={buttonVariants()}>
                        List a new piece
                      </Link>
                    ) : (
                      <p className="admin-form__hint">
        ...
        <TabsContent value="listings">
          <Card variant="brand">
            <CardHeader>
              ...
              <Link href="/artist/artworks" className={buttonVariants()}>
                Manage all listings
              </Link>
            </CardHeader>
            <CardContent>
